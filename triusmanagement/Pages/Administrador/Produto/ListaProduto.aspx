...
<body class="raleway">
    ...
    <div class="container-fluid">
        ...
        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered fundo-tabela">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lbAlterar" runat="server" CommandName="Alterar" CommandArgument='<%# Bind("pro_codigo")%>' CssClass="m-btn sm green nopad">Alterar</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
