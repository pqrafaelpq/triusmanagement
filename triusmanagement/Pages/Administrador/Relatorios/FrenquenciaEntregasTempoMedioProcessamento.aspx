<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrenquenciaEntregasTempoMedioProcessamento.aspx.cs" Inherits="Pages_Administrador_Relatorios_Frenquencia_de_Entregas" %>
...
<body class="bodypagina open-sans">
    <form id="form1" runat="server">
        ...
        <span class="caret"></span></a>
                        ...
                        <li>
                            <a href="FrenquenciaEntregasTempoMedioProcessamento.aspx" id="clicar">Recarregar</a>
        ...
        <div class="container">
            ...
            <h1 class="grande">Frequência de Entrega</h1>
            ...
            <button onclick="PrintElem('#semtabela')" class="m-btn green sm"><span class="glyphicon glyphicon-stats"></span></button><br /><br /></div>
            <div id="imprimir" class="text-center">
                ...
                <br />
                 <asp:Label ID="lblTotalPedidos" runat="server" CssClass="negrito"></asp:Label>
                <br />
                <asp:Label ID="lblTotaldeDias" runat="server" CssClass="negrito"></asp:Label>
                <br />
                <asp:Label ID="lblFrequencia" runat="server" CssClass="negrito"></asp:Label>
                <br />
                <asp:Label ID="lblTempoMedio" runat="server" CssClass="negrito"></asp:Label><br />
                <br />
                <br />
                    <div class="row">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvPedidos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered table-condensed">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ped_dataentrada" HeaderText="Data Entrada" HeaderStyle-CssClass="text-center" ApplyFormatInEditMode="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="ped_dataprevista" HeaderText="Data Prevista" HeaderStyle-CssClass="text-center" ApplyFormatInEditMode="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="ped_datapronto" HeaderText="Data Pronto" HeaderStyle-CssClass="text-center" ApplyFormatInEditMode="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="ped_qtddias" HeaderText="Dias de produção" HeaderStyle-CssClass="text-center" />
                        </Columns>
        ...
        <script>
            ...
            function Popup(data) { //FUNCAO QUE EFETIVAMENTE IMPRIME A DIV
                ...
                mywindow.document.write('<img src="../../../Content/ppnovo.png" onload="window.print()"  style="max-height:80px; float:left;" /><div style="margin-right:80px;"><h1 style="text-align:center; margin-top:0px !important; margin-bottom:0px !important;">Kifome Salgados<br>Relatório de Tempo de Processamento</h1></div>')
                mywindow.document.write('=============================================================================<br><br>')
