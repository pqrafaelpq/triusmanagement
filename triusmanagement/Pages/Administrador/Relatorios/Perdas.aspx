<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Perdas.aspx.cs" Inherits="Pages_Administrador_Relatorios_Perdas" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   ...
   <li class="dropdown">
        ...
        <span class="caret"></span></a>
                        ...
                        <li>
                            <a href="Perdas.aspx" id="clicar">Recarregar</a>
 ...
 &nbsp;<asp:Label ID="lblTotalPedidos" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                 <asp:Label ID="lblTotalTotal" runat="server" CssClass="h4 negrito"></asp:Label>
        <br />
&nbsp;<asp:Label ID="lblPorcentagemAtrasos" runat="server" CssClass="h4 negrito"></asp:Label>
        <br />
&nbsp;<asp:Label ID="lblTempoMedio" runat="server" CssClass="negrito"></asp:Label>

       

                <h3 class="negrito text-primary">Perdas por produto</h3>
                <div class="table-responsive">
   

        <asp:GridView ID="gvPerdasProduto" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered">
            <AlternatingRowStyle BackColor="#DCDCDC" />
            <Columns>
                <asp:BoundField DataField="per_produto" HeaderText="Produto" />
                <asp:BoundField DataField="sum(per_quantidade)" HeaderText="Quantidade Total" />
            ...
            <SortedDescendingHeaderStyle BackColor="#000065" />
                ...
                <br />
                 <h3 class="negrito text-primary">Detalhes das perdas</h3>
          
                <div class="table-responsive">
        <asp:GridView ID="gvPerdas" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered">
            <AlternatingRowStyle BackColor="#DCDCDC" />
            <Columns>
                <asp:BoundField DataField="per_produto" HeaderText="Produto" />
                <asp:BoundField DataField="per_quantidade" HeaderText="Quantidade" />
                <asp:BoundField DataField="per_data" HeaderText="Data da perda" ApplyFormatInEditMode="true" DataFormatString="{0:d}" />
                <asp:BoundField DataField="per_motivo" HeaderText="Motivo da Perda" />
         ...
         <script>
            ...
            function Popup(data) { //FUNCAO QUE EFETIVAMENTE IMPRIME A DIV
                ...
                mywindow.document.write('<img src="../../../Content/ppnovo.png" onload="window.print()"  style="max-height:80px; float:left;" /><div style="margin-right:80px;"><h1 style="text-align:center; margin-top:0px !important; margin-bottom:0px !important;">Kifome Salgados<br>Relatório de Perdas</h1></div>')
