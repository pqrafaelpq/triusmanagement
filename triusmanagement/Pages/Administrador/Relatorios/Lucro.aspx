...
<body class="bodypagina open-sans">
    <form id="form1" runat="server">
        ...
        <span class="caret"></span></a>
                        ...
                        <li>
                            <a href="Lucro.aspx" id="clicar">Recarregar</a>
        ...
        <div class="container">
            ...
            <h1 class="grande">Gastos e Lucros</h1>
            ...
            <div id="imprimir" class="text-center">
                ...
                &nbsp;<asp:Label ID="lblVendas" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                 &nbsp;<asp:Label ID="lblGastos" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                &nbsp;<asp:Label ID="lblLucro" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                <br />
                <br />
                ...
                <h3 class="negrito text-primary">Relação de Gastos</h3></div>
                <div class="table-responsive">


                    <asp:GridView ID="gvEntradaMateria" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered table-striped">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ent_data" HeaderText="Data" ApplyFormatInEditMode="true" DataFormatString="{0:d}"/>
                            
                        </Columns>
                        <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                        <HeaderStyle Font-Bold="True" ForeColor="White" BackColor="#2e8bcc"/>
                ...
                <br />
                <br />
                <div id="tituloa" runat="server">
                <h3 class="negrito text-primary">Relação de Vendas</h3></div>
                <div class="table-responsive">
                <asp:GridView ID="gvPedidosProntos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered">
                    <AlternatingRowStyle BackColor="#DCDCDC" />
                    <Columns>
                        <asp:BoundField DataField="ped_nomecliente" HeaderText="Cliente"  />
                        <asp:BoundField DataField="ped_quantidadetotal" HeaderText="Quantidade Total" />
                        <asp:BoundField DataField="ped_valortotal" HeaderText="Valor da venda"/>
                        <asp:BoundField DataField="ped_dataentrada" HeaderText="Data" ApplyFormatInEditMode="true" DataFormatString="{0:d}"/>
                    </Columns>
                    <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                    <HeaderStyle Font-Bold="True" ForeColor="White" BackColor="#2e8bcc"/>
                    <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
            ...
            function Popup(data) { //FUNCAO QUE EFETIVAMENTE IMPRIME A DIV
                ...
                mywindow.document.write('<img src="../../../Content/ppnovo.png" onload="window.print()"  style="max-height:80px; float:left;" /><div style="margin-right:80px;"><h1 style="text-align:center; margin-top:0px !important; margin-bottom:0px !important;">Kifome Salgados<br>Relatório de Gastos e Lucros</h1></div>')
                mywindow.document.write('=============================================================================<br><br>')
