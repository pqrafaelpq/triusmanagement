...
<body class="bodypagina open-sans">
    <form id="form1" runat="server">
        ...
        <span class="caret"></span></a>
                        ...
                        <li>
                            <a href="PorcentagemAtraso.aspx" id="clicar">Recarregar</a>
        ...
        <div class="container">
            ...
            <button onclick="PrintElem('#semtabela')" class="m-btn green sm"><span class="glyphicon glyphicon-stats"></span></button><br /><br /></div>    <br />
                <br />
            </div>
            ...
            <div id="imprimir" class="text-center">
                ...
                <br />
                <asp:Label ID="lblTotalGeral" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                &nbsp;<asp:Label ID="lblPorcentagemAtrasos" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                &nbsp;<asp:Label ID="lblTempoMedio" runat="server" CssClass="h4 negrito"></asp:Label>
                <br />
                <br />
                <br />
                ...
                <div id="titulo" runat="server"><br /><br /><br />
                <h3 class="negrito text-primary">Pedidos atrasados</h3></div>
                <div class="table-responsive">

                 
                    <asp:GridView ID="gvPedidosAtrasados" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="table table-bordered">
                        <AlternatingRowStyle BackColor="#DCDCDC" />
                        <Columns>
                            <asp:BoundField DataField="pea_nomecliente" HeaderText="Cliente" />
                            <asp:BoundField DataField="pea_quantidadetotal" HeaderText="Quantidade de itens" />
                            <asp:BoundField DataField="pea_valortotal" HeaderText="Valor Total" />
                            <asp:BoundField DataField="pea_dataentrada" HeaderText="Data Entrada" ApplyFormatInEditMode="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="pea_dataprevista" HeaderText="Data Prevista" ApplyFormatInEditMode="true" DataFormatString="{0:d}"/>
                            <asp:BoundField DataField="pea_datapronto" HeaderText="Data Pronto" ApplyFormatInEditMode="true" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="pea_qtddias" HeaderText="Dias de atraso" />
                        </Columns>
         ...
         <script>
            ...
            function Popup(data) { //FUNCAO QUE EFETIVAMENTE IMPRIME A DIV
                ...
                var mywindow = window.open('', 'new div', 'height=700,width=600');
                mywindow.document.write('<html><head><title>Detalhes</title>');
                
                mywindow.document.write('</head><body >');
                mywindow.document.write('=============================================================================')
                mywindow.document.write('<img src="../../../Content/ppnovo.png" onload="window.print()"  style="max-height:80px; float:left;" /><div style="margin-right:80px;"><h1 style="text-align:center; margin-top:0px !important; margin-bottom:0px !important;">Kifome Salgados<br>Relatório de Atrasos</h1></div>')
